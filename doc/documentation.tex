...
%
%
\section{Tabulka instrukci a ocekavane poradi / stavovy diagram}
TODO
...
\begin{itemize}
	...
	\item Negativní
		\begin{itemize}
			...
			\item 403 - Username already in use
			\item 404 - Server failed to add player
			\item 405 - Player with this ID doesn't exist (zmenit?)
			\item 406 - Is this an attack attempt (docasny)
		\end{itemize}
\end{itemize}
%
%
...
\begin{itemize}
	...
	\item Negativní
		\begin{itemize}
			...
			\item 403 - Failed to find game lobby
			\item 404 - Unexpected token count
			\item 405 - Failed to parse ID
			\item 406 - Opponent starting error
			\item 407 - Unrecognized instruction
		\end{itemize}
\end{itemize}
%
%
...
\begin{itemize}
	...
	\item Negativní
		\begin{itemize}
			\item 402 - No game found for this player
		\end{itemize}
\end{itemize}
%
%
...
\begin{itemize}
	...
	\item Negativní
		\begin{itemize}
			\item 402 - Failed to find game
			\item 403 - Need starting position
			\item 404 - Failed to validate move
			\item 405 - This is not your game
			\item 406 - Parameter isn't number
			\item 407 - Failed to contact opponent
		\end{itemize}
\end{itemize}
%
%
